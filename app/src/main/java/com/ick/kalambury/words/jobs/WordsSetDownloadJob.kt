...
import com.ick.kalambury.words.AESCipherStreamsFactory
import com.ick.kalambury.words.Secret
...
class WordsSetDownloadJob @AssistedInject constructor(
    ...
    private val wordsStorage: WordsSetDataSource,
        ...
        return restApiManager.getWordsSet(setId)
            .flatMap { result ->
                result.fold({
                    ...
                    wordsStorage.saveWordsSet(setId, stream, "new")
